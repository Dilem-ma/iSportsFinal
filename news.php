...
<div id="news_right">
    ...
    <div class="news">
              ...
              <?php
                    ...
                    for($i=0;$i<$count&&$items<$per_page_num;$i++)
                    {
						...
						?>
              <dl class="news_nopic">
        <dd class="title"><a href="<?php echo "detail.php?a=".$news_num ?>"><?php echo "$title" ?></a></dd>
        </dd-->
        <dd class="content_detail"><?php echo "$intro";?><a href="<?php echo "detail.php?a=".$news_num ?>">详情</a></dd>
      </dl>
              <?php
                        $items++;
                    }
    ...
    </div><div class="bg"> <img id="bgImg" class="bg" alt="Background image" src="images/news_bg.jpg" /> </div>
